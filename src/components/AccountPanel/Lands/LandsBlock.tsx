...
export const LandsBlock: FC = () => {
  ...
  return (
    <div className="lands__items-item" onClick={() => handlerNavigate("1")}>
      <div className="lands__items-item-top">
        ...
        <div className="lands__items-item-like">
          <svg
            width="32"
            height="32"
            viewBox="0 0 32 32"
      ...
      <div className="lands__items-item-image">
        <img className="lands__items-item-img" src={img1} alt="" />
      </div>
      <div className="lands__items-item-title">Germany, Berlin</div>
